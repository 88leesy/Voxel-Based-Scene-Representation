...
#define EPSILON (0.08)  // distance for clustering, metre^2
	...
	int cubeSize = 40;          //king-100(나중에 120으로 해보자), old-30, shop-40, stmary-50(얘는 70으로 해보자)
	...
	ds.voxelFitting3(ds.m_points, ds.getTotalPointSize(), color, nLabel, cubeSize);  //만들어야함.
